...
const NoProductAvailable = ({
  ...
  return (
    ...
    >
      ...
      >
        Xin lỗi, hiện tại không có sản phẩm nào phù hợp với{" "}
      ...
      >
        ...
        <span>Chúng tôi đang nhập hàng trở lại</span>
      </motion.div>
      ...
      >
        Vui lòng quay lại sau hoặc khám phá các danh mục sản phẩm khác.
      </motion.p>
    </div>
  );
};
